        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Integrate payments into your platform with our RESTful API. Create payments, manage refunds, and receive webhooks — all programmatically.
            </p>
            ...
            <motion.img
              ...
              width={800}
              height={600}
              className="w-64 mx-auto lg:mx-0 mb-8 drop-shadow-xl hidden lg:block"
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <motion.div
                  ...
                  className="flex items-start gap-3 p-4 rounded-xl bg-secondary border border-border/50 hover:border-accent/30 transition-all"
                >
                ...
                <div className="flex gap-1">
                  {(["javascript", "python", "curl"] as const).map((l) => (
                    <button
                      key={l}
                      onClick={() => setLang(l)}
                      className={`px-3 py-1 rounded-md text-xs font-medium transition-all ${lang === l
