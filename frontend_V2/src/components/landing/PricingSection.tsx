        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {plans.map((plan, index) => (
            <motion.div
              ...
              whileHover={{ y: -10, scale: plan.highlighted ? 1.08 : 1.03 }}
              className={`relative rounded-2xl p-8 transition-shadow duration-300 ${plan.highlighted
            ...
            >
              {plan.highlighted && (
                <motion.div
                  ...
                  className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-accent text-accent-foreground text-xs font-bold rounded-full flex items-center gap-1"
                >
