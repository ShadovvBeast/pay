      ...
      <div className="border-b border-primary-foreground/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <motion.div
            ...
            className="relative rounded-2xl bg-gradient-to-r from-accent/10 via-accent/5 to-accent/10 border border-accent/20 p-8 lg:p-10 text-center overflow-hidden"
          >
            <motion.div
            ...
            <div className="relative z-10">
              ...
              <h3 className="font-display text-2xl lg:text-3xl font-bold text-primary-foreground mb-3">
                Mobile Money is Coming Soon! 🚀
              </h3>
              <p className="text-primary-foreground/60 max-w-xl mx-auto mb-6 leading-relaxed">
                We're building support for M-Pesa, MTN Mobile Money, Airtel Money, and more.
                Accept mobile payments from customers across Africa and beyond.
              </p>
      ...
      <div className="border-b border-primary-foreground/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          >
            ...
            <p className="text-lg text-primary-foreground/50 max-w-lg mx-auto mb-8">
              Join thousands of merchants who've simplified their payment process with SB0 Pay.
            </p>
            <Button
              size="lg"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-sm text-primary-foreground/50 leading-relaxed">
              The simplest way to accept payments. Turn your phone into a point of sale.
            </p>
          </div>
        ...
        <div className="border-t border-primary-foreground/10 pt-8 text-center">
          <p className="text-sm text-primary-foreground/40">
            © {new Date().getFullYear()} SB0 Pay. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
